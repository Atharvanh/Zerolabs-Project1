...
const init = () => {
    ...
    // Dark blue/black background matching prompt explicitly
    ...
    const fragmentShader = `
        ...
        void main() {
            ...
            // Ocean to AI Network colors
            vec3 colorDeep = vec3(0.0, 0.1, 0.4);   // Deep Dark Blue
            vec3 colorMid = vec3(0.0, 0.4, 0.9);    // Bright Blue
            vec3 colorPeak = vec3(0.0, 1.0, 1.0);   // Neon Cyan
            vec3 colorGlow = vec3(1.0, 1.0, 1.0);   // White Glow
    ...
    const pMaterial = new THREE.PointsMaterial({
        color: 0x00ffff, // Cyan/white glow
        size: 0.35,
        transparent: true,
        opacity: 0.4,
        blending: THREE.AdditiveBlending,
